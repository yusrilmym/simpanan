...
<head>
    ...
    <title>SIMPANAN (Sistem Informasi)</title>
                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">Go to Anggaran Panel</a></p>
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="ppk/index.php">Go to PPTK Panel</a></p>
                        </div>
                    </div>
                </form>
            </div>
