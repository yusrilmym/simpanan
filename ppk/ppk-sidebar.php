<nav>
        ...
        <li class="<?php if($page=='anggaran') {echo 'active';} ?>"><a href="inputanggaran.php"><i class="ti-id-badge"></i> <span>Anggaran</span></a></li>
<!--                         
        <li class="<?php if($page=='department') {echo 'active';} ?>"><a href="department.php"><i class="fa fa-th-large"></i> <span>Department Section</span></a></li>
         ...
         <li class="<?php if($page=='leave') {echo 'active';} ?>"><a href="leave-section.php"><i class="fa fa-sign-out"></i> <span>Jenis Pengajuan</span></a></li>

        <li class="<?php if($page=='manage-leave') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-briefcase"></i><span>Kelola Pengajuan</span></a>
            ...
            <ul class="collapse">
                ...
                <li ><a href="leave-history.php"><i class="fa fa-history"></i> History Pengajuan</a></li>
            </ul>
