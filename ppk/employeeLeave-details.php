<?php
    ...
    $sql="UPDATE tblleaves set AdminRemark=:description,Status=:status,Pptk=:pptk,AdminRemarkDate=:admremarkdate where id=:did";
    $query = $dbh->prepare($sql);
    $query->bindParam(':description',$description,PDO::PARAM_STR);
    $query->bindParam(':status',$status,PDO::PARAM_STR);
    $query->bindParam(':pptk',$pptk,PDO::PARAM_STR);
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Details Pengajuan</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Home</a></li>
                                <li><span>Details Pengajuan</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">PPK <i class="fa fa-angle-down"></i></h4>
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.LeaveType,tblleaves.kajian,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate, tblleaves.Pptk from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
                                            $query = $dbh -> prepare($sql);
                                ...
                                <td ><b>PPTK/ Sub Bag:</b></td>
                                <td><?php echo htmlentities($result->Pptk);?></td>
                                ...
                                <tr>
                                     <td ><b>Kajian: </b></td>
                                     <td colspan="5"><?php echo htmlentities($result->kajian);?></td>
                                          
                                </tr>
                                
                                <tr>
                                    <td ><b>Jawaban PPK : </b></td>
                                    <td colspan="12"><?php
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body">
                                <select class="custom-select" name="pptk" required="">
                                        <option value="">Jika Disetujui pilih PPTK...</option>
                                        <option value="umum">KASUBAG Umum</option>
                                        <option value="pelayananmedik">KASUBAG Pelayanan Medik</option>
                                        <option value="kasieper">KASIE Penunjang Keperawatan</option>
