<?php
    ...
    $query -> execute();
    header('location:anggaranobat.php');
    }
    ...
    if(isset($_POST['masuk'])){ 
        ...
        $sql="INSERT INTO pembeliantes(LeaveType,uraian, koefisien, satuan, harga,res) VALUES(:LeaveType,:uraian,:koefisien,:satuan,:harga,:res)";
        $query = $dbh->prepare($sql);
                        ...
                        <div class="container">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="prosestes.php" method="POST">
