<?php
    ...
    $msg="Jenis Pengajuan updated successfully";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Jenis Pengajuan</h4>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update Jenis Pengajuan</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Jenis Pengajuan</label>
