<?php
    ...
    $query->bindParam(':did',$did,PDO::PARAM_STR);
    $query->execute();
    $msg="Pengajuan updated Successfully";
    } ?>
                        ...
                        <div class="card">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <select class="custom-select" name="pptk" required="">
                                        <option value="">Jika Disetujui pilih Ninuninu...</option>
                                        <option value="yusril">yusril</option>
